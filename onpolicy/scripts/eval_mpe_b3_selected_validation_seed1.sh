...
"$BASE_PYTHON" onpolicy/scripts/eval/eval_mpe_b3_gate.py \
  ...
  --eval_episodes 500 --eval_batch_size 25 --eval_seed_start 20000 \
  ...
  --output_dir onpolicy/scripts/results/MPE/simple_spread/headroom_b3/validation_selected_mean_0.03_seed20000_500 \
