...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES=0 /root/miniconda3/bin/python \
  ...
  --experiment_name b4_selector_1m \
  ...
  --episode_length 25 --num_env_steps 1000000 --ppo_epoch 10 \
  --data_chunk_length 10 --use_ReLU --gain 0.01 \
  --lr 1e-4 --critic_lr 7e-4 --use_linear_lr_decay \
  --model_dir onpolicy/scripts/results/MPE/simple_spread/selective_mappo/b4_selector_100k/run1/models \
