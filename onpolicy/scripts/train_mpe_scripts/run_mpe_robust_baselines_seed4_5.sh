...
# Extend the frozen three-seed robust baseline protocol to training seeds 4 and 5.
# Keep every optimization and corruption-training option identical to seeds 1--3.
...
echo "ROBUST_BASELINES_SEED4_5_COMPLETE"
